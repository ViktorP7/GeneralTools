# Tool to parse bcftools csq output and collect relevant information in a table
# Author Viktor Perets
# Version 1.02 28-08-18
# 1.01 - Added MQ filter to matrix (set to 30) and provided more info for fail reason
# 1.02 - Made filters more lenient. DP to 10, DP4 to 2, MQ to 20. Changed output not to show filter values.
...
if len(sys.argv) < 1:
    print("Incorrect number of arguments, please try again using instructions below: \n"
          ...
          "python CompareConsequences20-08-18 directory_path \n"
...
outputFile = "ComCsq_{}.tsv".format(datetime.datetime.today().strftime('%Y-%m-%d'))
print(outputFile)

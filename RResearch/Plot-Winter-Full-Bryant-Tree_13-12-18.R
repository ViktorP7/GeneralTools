...
pathTree <- "C:/Users/UCD/Desktop/UbuntuSharedFolder/Winter2018MAPSequencing/MAP-FASTQs/vcfFiles/Bryantandus/CombinedTree.tree"
...
pdf("CombinedDecember2018Tree.pdf", width=20, height=20)
...
rootree$edge.length <- rootree$edge.length * 18367
